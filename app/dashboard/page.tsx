...
import { STAGE_LABELS, type Candidate } from '@/lib/types';
...
export default function Dashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const stageDistribution = candidateStats.reduce((acc: Record<string, number>, candidate) => {
    ...
    <Layout>
      ...
      >
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <motion.div whileTap={{ scale: 0.98 }}>
              <Button asChild size="sm" className="h-7 px-1 text-xs bg-[#1f1687] hover:bg-[#161357]">
                <Link href="/jobs" className="flex items-center text-white">
        ...
        <div className="grid gap-8 lg:grid-cols-3 flex-1">
          ...
          {/* Right Side Content - Pipeline Overview */}
