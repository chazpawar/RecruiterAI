      ...
      sections.push(createSection({
        ...
        questions: [
          ...
          createQuestion({
            ...
            required: true,
            validation: { minLength: 100, maxLength: 1000, minValue: null, maxValue: null, pattern: null },
          }),
        ],
      }));
    }
    ...
    sections.push(createSection({
      ...
      questions: [
        createQuestion({
          ...
          required: true,
          validation: { maxLength: 500, minLength: null, minValue: null, maxValue: null, pattern: null },
        }),
        createQuestion({
          type: QUESTION_TYPES.NUMERIC,
          title: 'Rate your problem-solving skills on a scale of 1-10',
          required: true,
          validation: { minValue: 1, maxValue: 10, minLength: null, maxLength: null, pattern: null },
        }),
        createQuestion({
          type: QUESTION_TYPES.SINGLE_CHOICE,
    ...
    sections.push(createSection({
      ...
      questions: [
        ...
        createQuestion({
          ...
          required: false,
          validation: { maxLength: 800, minLength: null, minValue: null, maxValue: null, pattern: null },
        }),
        createQuestion({
          type: QUESTION_TYPES.SHORT_TEXT,
          title: 'What are your career goals for the next 2 years?',
          required: true,
          validation: { maxLength: 300, minLength: null, minValue: null, maxValue: null, pattern: null },
        }),
      ],
    }));
...
export const generateSeedData = (): { jobs: Job[]; candidates: Candidate[]; assessments: Assessment[] } => {
