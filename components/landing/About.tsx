      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
          <div className="relative space-y-4">
            ...
            <p className="text-muted-foreground text-left">
              It supports an entire ecosystem — from job posting platforms to
              assessment tools and analytics helping HR teams and businesses
            ...
            <div className="grid grid-cols-2 gap-3 pt-6 sm:gap-4">
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground text-sm text-left">
                  Match candidates with perfect roles using advanced algorithms.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm text-left">
                  Enable seamless teamwork across HR and hiring managers.
                </p>
              </div>
            </div>
          </div>
